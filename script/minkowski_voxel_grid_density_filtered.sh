...
ITERATION=50000  # Use latest iteration
CELL_SIZE=0.02  # Size of voxel grid cells
...
OPACITY_THRESHOLD=0.99 # Minimum opacity for a gaussian to be considered part of the surface
